...
namespace Lockstep.Serialization.Test {
    public partial class TestClassBase : ICompatibleExt {
        public virtual void SerializeExt(Serializer writer){
            ...
            offsetTable[2] = writer.Position;if (val0 != 0) writer.Write(val2);else{offsetTable[2] = 0;}
            offsetTable[3] = writer.Position;if (val0 != 0) writer.Write(val3);else{offsetTable[3] = 0;}
            offsetTable[4] = writer.Position;if (val0 != 0) writer.Write(val4);else{offsetTable[4] = 0;}
